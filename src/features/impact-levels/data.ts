...
export const impactLevels: ImpactLevelSpec[] = [
  {
    ...
    miltech: "Public documentation, marketing assets",
  },
  {
    ...
    miltech: "Vessel design specs (ITAR), autonomy algorithms under EAR",
  },
  {
    ...
    miltech: "Autonomous vessel C2 data, real-time telemetry, sensor fusion",
  },
  {
    ...
    miltech: "Classified mission parameters, fleet coordination data",
  },
]

export const capArchitecture: FlowNode[] = [
  { name: "MilTech FedRAMP AWS GovCloud", sub: "IL4/IL5 Workloads", icon: "GC", color: COLORS.warning },
